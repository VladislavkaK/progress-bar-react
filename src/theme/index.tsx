...
export const Text: any = styled(Box.withComponent(withThemedMotion(motion.p))).attrs<TextProps>(
    ({ center, variant }) => ({
...
export const Link: any = Box.withComponent(withThemedMotion(motion.a));
...
export const Input: any = Box.withComponent(withThemedMotion(motion.input));
